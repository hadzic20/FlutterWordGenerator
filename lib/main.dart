  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 255, 34, 196)),
        ),
        home: MyHomePage(),
      ),
    );
...
class FavoritesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var list = appState.favorites.toList();
    return ListView(
      children: [
        ListTile(
...
class GeneratorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var appState = context.watch<MyAppState>();
    var pair = appState.current.asLowerCase;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 10),
              ElevatedButton(onPressed: () {appState.getWord();}, child: Text('Give me a word')),
            ],
          ),
        ],
      ),
